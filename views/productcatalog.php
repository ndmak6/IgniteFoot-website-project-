                            ...
                            <div class="col-lg-6">
                                <div class="shop-details-img">
                                    ...
                                    <div class="nav nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        ...
                                        <button class="nav-link" id="v-pills-img2-tab" data-bs-toggle="pill" data-bs-target="#v-pills-img2" type="button" role="tab" aria-controls="v-pills-img2" aria-selected="false" tabindex="-1">
                                            <img src="assets/image/inner-page/shop-details-nav-img2.png" alt="">
                                        </button>
                                        <button class="nav-link" id="v-pills-img3-tab" data-bs-toggle="pill" data-bs-target="#v-pills-img3" type="button" role="tab" aria-controls="v-pills-img3" aria-selected="false" tabindex="-1">
                                            <img src="assets/image/inner-page/shop-details-nav-img3.png" alt="">
                                        </button>
                                        <button class="nav-link" id="v-pills-img4-tab" data-bs-toggle="pill" data-bs-target="#v-pills-img4" type="button" role="tab" aria-controls="v-pills-img4" aria-selected="false" tabindex="-1">
                                            <img src="assets/image/inner-page/shop-details-nav-img4.png" alt="">
                                        </button>
                                        <button class="nav-link" id="v-pills-img5-tab" data-bs-toggle="pill" data-bs-target="#v-pills-img5" type="button" role="tab" aria-controls="v-pills-img5" aria-selected="false" tabindex="-1">
                                ...
                                <div class="shop-details-content">
                                                ...
                                                <a href="whislist.html">
                                                    <span>
                                                        <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M8.4692 1.95762C7.54537 1.2193 6.18482 1.36068 5.32818 2.17755L5.00904 2.49173L4.6731 2.17755C3.83325 1.36068 2.4559 1.2193 1.53207 1.95762C0.473867 2.80591 0.423476 4.31397 1.3641 5.22509L4.62271 8.36688C4.82427 8.57109 5.177 8.57109 5.37857 8.36688L8.63717 5.22509C9.5778 4.31397 9.52741 2.80591 8.4692 1.95762Z" stroke="#595959"></path>
                                                        </svg>
                                                    </span>
                                                    Add to wishlist
                                                </a>
                                    ...
                                    <div class="product-info">
                                        <ul class="product-info-list">
                                            ...
                                            <li> <span>Category:</span> <a href="/shop-slider.html">Women,Jacket,Outwear</a>, <a href="/shop-slider.html">Face</a>
                                            </li>
                                            <li> <span>Brand:</span> <a href="/shop-slider.html">Zaara</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false" tabindex="-1">Registration</button>
                        </li>
                    </ul>
                </div>
                <div class="modal-body">
                                ...
                                <div class="col-xl-3 dd--none">
                                    <div class="megamenu-items">
                                        ...
                                        <div class="swiper menu-product-slider swiper-initialized swiper-horizontal">
                                            <div class="swiper-wrapper" id="swiper-wrapper-069d75d1c17832e2" aria-live="off" style="transition-duration: 1500ms;">
                ...
                <li>
                    <div class="cart-area">
                        <a href="cart-page.html">
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3.375 4.78125H14.625M6.1875 4.78125V3.51562C6.1875 1.96232 7.44669 0.703125 9 0.703125C10.5533 0.703125 11.8125 1.96232 11.8125 3.51562V4.78125M11.8125 7.59375C11.8125 9.14706 10.5533 10.4062 9 10.4062C7.44669 10.4062 6.1875 9.14706 6.1875 7.59375" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M14.625 4.78125L16.0201 15.7131C16.0275 15.772 16.0313 15.8313 16.0312 15.8906C16.0312 16.6673 15.4016 17.2969 14.625 17.2969H3.375C2.59836 17.2969 1.96875 16.6673 1.96875 15.8906C1.96875 15.8305 1.97251 15.7712 1.97986 15.7131L3.375 4.78125" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                        </a>
                        <span>0</span>
                    </div>
                ...
                <a class="search-btn">
                    <div class="icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10.9379 1.93066C8.55343 1.93466 6.26777 2.88366 4.5817 4.56974C2.89562 6.25581 1.94662 8.54147 1.94263 10.9259C1.94462 13.3124 2.89249 15.6008 4.57857 17.2897C6.26465 18.9786 8.55143 19.9303 10.9379 19.9363C13.0544 19.9363 15.0047 19.1918 16.5467 17.9596L21.4104 22.8236C21.6001 23 21.8509 23.0961 22.1099 23.0915C22.369 23.087 22.6162 22.9822 22.7997 22.7993C22.9831 22.6163 23.0885 22.3694 23.0938 22.1103C23.099 21.8513 23.0036 21.6003 22.8277 21.4101L17.964 16.5423C19.2433 14.9514 19.9407 12.9712 19.9407 10.9297C19.9407 5.97098 15.8966 1.93066 10.9379 1.93066ZM10.9379 3.93381C14.8157 3.93381 17.9376 7.05193 17.9376 10.9259C17.9376 14.8 14.8157 17.937 10.9379 17.937C7.06011 17.937 3.942 14.8113 3.942 10.9335C3.942 7.0557 7.06011 3.93381 10.9379 3.93381Z"></path>
                        </svg>
                    </div>
                    <span>Search</span>
                </a>
                <div class="search-input">
                    ...
                    <form>
                        ...
                        <div class="quick-search">
                            <ul>
                                <li>Quick Search :</li>
                                <li><a href="categories2.html">Men,</a></li>
                                <li><a href="categories2.html">Women,</a></li>
                                <li><a href="categories2.html">kids.</a></li>
                            </ul>
                        </div>
                    </form>
                </div>
                ...
                <a href="#">
                    <div class="icon">
                        ...
                        <svg class="cart" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4.5 6.375H19.5M8.25 6.375V4.6875C8.25 2.61642 9.92892 0.9375 12 0.9375C14.0711 0.9375 15.75 2.61642 15.75 4.6875V6.375M15.75 10.125C15.75 12.1961 14.0711 13.875 12 13.875C9.92892 13.875 8.25 12.1961 8.25 10.125" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M19.5 6.375L21.3602 20.9507C21.3701 21.0293 21.375 21.1083 21.375 21.1875C21.375 22.223 20.5355 23.0625 19.5 23.0625H4.5C3.46448 23.0625 2.625 22.223 2.625 21.1875C2.625 21.1073 2.63002 21.0283 2.63981 20.9507L4.5 6.375" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                        </svg>
                    </div>
                    <span>Cart</span>
                </a>
                            ...
                            <div class="row gy-4">
                                <div class="col-lg-4 col-md-6 col-sm-6 item wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 200ms;">
                                    <div class="product-card">
                                        <div class="product-card-img">
                                            <a href="product-details.html">
                                                <img src="assets/image/inner-page/product-image.png" alt="">
                                                <div class="batch">
                                        ...
                                        <div class="product-card-content">
                                            ...
                                            <h6><a class="hover-underline" href="product-details.html">Ultimate Comfort &amp; Trendy Design</a>
                                            </h6>
                                            ...
                                            <ul class="color-tag">
                                                ...
                                                <li class="plus-icon">
                                                    <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M3.5 4.5V8H4.5V4.5H8V3.5H4.5V0H3.5V3.5H0V4.5H3.5Z" fill="black"></path>
                                                    </svg>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 600ms;">
                                    <div class="product-card">
                                        <div class="product-card-img">
                                            <a href="product-details.html">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 800ms;">
                                    <div class="product-card">
                                        <div class="product-card-img">
                                            <a href="product-details.html">
                        ...
                        <div class="foort-top-content">
                            ...
                            <div class="countdown-timer">
                                <ul data-countdown="2025-09-15 12:00:00">
                                    <li data-days="00"><strong>00</strong> <span>Days</span></li>
                                    <li data-hours="00"><strong>00</strong> <span>Hours</span></li>
                                    <li data-minutes="00"><strong>00</strong> <span>Minutes</span></li>
                                    <li data-seconds="00"><strong>00</strong> <span>Seconds</span></li>
                                </ul>
                            </div>
                            ...
                            <div class="right-area">
                                <svg width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <g>
                                        ...
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M11.3998 1C11.559 1 11.7116 1.06585 11.8241 1.18306C11.9366 1.30027 11.9998 1.45924 11.9998 1.625V10.375C11.9998 10.5408 11.9366 10.6997 11.8241 10.8169C11.7116 10.9342 11.559 11 11.3998 11C11.2407 11 11.0881 10.9342 10.9755 10.8169C10.863 10.6997 10.7998 10.5408 10.7998 10.375V1.625C10.7998 1.45924 10.863 1.30027 10.9755 1.18306C11.0881 1.06585 11.2407 1 11.3998 1Z"></path>
                                    </g>
                                </svg>
