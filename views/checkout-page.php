...
<body>
    ...
    <div class="breadcrumb-section mb-100"
        style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.35), rgba(0, 0, 0, 0.35)), url(assets/image/inner-page/breadcrumbs-image6.jpg);">
        <div class="container">
            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-30">
                                        <div class="form-inner">
                                            ...
                                            <input type="text" placeholder="Nơi nhận hàng">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-30">
                                        <div class="form-inner">
                                            <label>Mã bưu điện<span>*</span></label>
                                            <input type="email" placeholder="Mã bưu chính">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-15">
                                        <div class="form-inner">
                                            <label>mô tả<span>*</span></label>
                                            <textarea placeholder="Văn bản của bạn ở đây"></textarea>
                                        </div>
                                    </div>
